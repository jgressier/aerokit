...
def test_PrandtlMeyer_Mach():
    assert sup.PrandtlMeyer_Mach(2.     ) == pytest.approx(26.3797608)
    assert sup.PrandtlMeyer_Mach(2., 1.1) == pytest.approx(34.8813639)
    assert sup.PrandtlMeyer_Mach(1.5, 2 ) == pytest.approx(8.69455340)
    assert sup.PrandtlMeyer_Mach(1      ) == pytest.approx(0.)

def test_Mach_PrandtlMeyer():
    assert sup.Mach_PrandtlMeyer(26.3797608     ) == pytest.approx(2.)
    assert sup.Mach_PrandtlMeyer(34.8813639, 1.1) == pytest.approx(2.)
    assert sup.Mach_PrandtlMeyer(8.69455340, 2  ) == pytest.approx(1.5)
    assert sup.Mach_PrandtlMeyer(0              ) == pytest.approx(1.)

def test_old_Mach_PrandtlMeyer():
    assert sup.Mach_PrandtlMeyer(26     ) == pytest.approx(sup.old_Mach_PrandtlMeyer(26     ))
    assert sup.Mach_PrandtlMeyer(34, 1.1) == pytest.approx(sup.old_Mach_PrandtlMeyer(34, 1.1))
    assert sup.Mach_PrandtlMeyer(8 , 2  ) == pytest.approx(sup.old_Mach_PrandtlMeyer(8 , 2  ))

def test_Mach_PrandtlMeyer_reverse():
    assert sup.PrandtlMeyer_Mach(sup.Mach_PrandtlMeyer(2)) == pytest.approx(sup.Mach_PrandtlMeyer(sup.PrandtlMeyer_Mach(2)))
    assert sup.PrandtlMeyer_Mach(sup.Mach_PrandtlMeyer(2.5)) == pytest.approx(sup.Mach_PrandtlMeyer(sup.PrandtlMeyer_Mach(2.5)))
    assert sup.PrandtlMeyer_Mach(sup.Mach_PrandtlMeyer(1)) == pytest.approx(sup.Mach_PrandtlMeyer(sup.PrandtlMeyer_Mach(1)))
    assert sup.PrandtlMeyer_Mach(sup.Mach_PrandtlMeyer(1.1, 1.4)) == pytest.approx(sup.Mach_PrandtlMeyer(sup.PrandtlMeyer_Mach(1.1, 1.4)))
